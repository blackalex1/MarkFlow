export const en = {
    ...
    toast_ssh_saved: "SSH keys saved successfully",
    btn_show_key: "Show Key",
    warn_load_key_first: "Load the key first",
    toast_url_to_ssh: "URL converted to SSH format",
    toast_unique_key_generated: "Unique key pair generated successfully",
    toast_key_gen_failed: "Failed to generate key pair",
    toast_key_not_found: "No key found for this repository",
    toast_key_fetch_error: "Error fetching key from server",
    repo_key_title_unique: "Unique Public Key",
    repo_key_title_global: "Global Public Key",
