export const ru = {
    ...
    sec_2fa_desc_on: "Ваш аккаунт защищен вторым фактором",
    sec_2fa_desc_off: "Дополнительная защита вашего аккаунта",
    sec_pass_fill_both: "Заполните оба поля",
    sec_pass_changed: "Пароль изменен! Пожалуйста, войдите снова.",
    sec_logout_all_confirm: "Выйти со всех устройств?",
    sec_network_error: "Ошибка сети",
    ...
    toast_repo_activated: "Репозиторий активирован",
    toast_repo_deleted: "Репозиторий удален",
    toast_repo_activate_error: "Ошибка при активации репозитория",
    toast_repo_delete_error: "Ошибка при удалении репозитория",
    error_prefix: "Ошибка",
    ...
    toast_pubkey_copied: "Публичный ключ скопирован в буфер обмена",
    toast_branches_loaded: "Список веток успешно загружен",
    toast_generated_saved: "Ключ успешно создан и сохранен на сервере",
    toast_ssh_saved: "Ключи успешно сохранены",
    btn_show_key: "Показать ключ",
    warn_load_key_first: "Сначала загрузите ключ",
    toast_url_to_ssh: "URL автоматически изменен на SSH формат",
    toast_unique_key_generated: "Уникальная пара ключей успешно создана",
    toast_key_gen_failed: "Не удалось создать пару ключей",
    toast_key_not_found: "Ключ для этого репозитория не найден",
    toast_key_fetch_error: "Ошибка при получении ключа с сервера",
    repo_key_title_unique: "Уникальный публичный ключ",
    repo_key_title_global: "Глобальный публичный ключ",
    warn_fill_required: "Пожалуйста, заполните обязательные поля (Имя, Slug, URL)",
    warn_enter_url: "Сначала введите URL репозитория",
    error_fetch_branches: "Не удалось загрузить список веток",
    error_save_repo: "Ошибка при сохранении настроек репозитория",
    ...
    toast_user_created: "Пользователь успешно создан",
